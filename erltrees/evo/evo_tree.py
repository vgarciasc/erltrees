...
class Individual(tree.TreeNode):
    def __init__(self, fitness, reward, std_reward, **kwargs):
    ...
    def generate_random_node(config):
        ...
        return Individual(fitness=None, reward=None, std_reward=None,
    ...
    def read_from_string(config, string):
        ...
        for line in lines[1:]:
            ...
            if not is_leaf:
                ...
                node = Individual(fitness=-1, reward=-1, std_reward=-1, 
